    ...
    describe('using pathname', () => {
      describe("real shop's URLs", () => {
        ...
        it('returns Product Details Page for real PDP URLs', () => {
          ...
          expect(getShopifyServiceName(realShopUrls.commerceTown.product)).toBe(
            shopifyServices.PDP.name,
          );
        });
        ...
        it('returns Checkout for real checkouts URLs', () => {
          ...
          expect(
            getShopifyServiceName(realShopUrls.commerceTown.checkout),
          ).toBe(shopifyServices.CHECKOUT.name);
        });
        ...
        it('returns Pages for real pages URLs', () => {
          ...
          expect(getShopifyServiceName(realShopUrls.commerceTown.page)).toBe(
            shopifyServices.PAGE.name,
          );
        });
      });
